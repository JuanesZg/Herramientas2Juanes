static class OrquestadorConsola
{
    ...
    public static void solicitarDatosPersonas()
    {
        ...
        do
        {
            ...
            Console.WriteLine("Si desea inscribir a una persona digite un número diferente al 0. Si desea salir digite el número 0");
    ...
    {
        Console.WriteLine("La cantidad de personas registrdas es:" + personas.Count);
        int numeroNinnos = 0;
        int numeroAdultos = 0;
